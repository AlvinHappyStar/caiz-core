...
- **Ledger**: A ledger is the state of the distributed Caiz database at a
...
- **Ledger header**: The ledger's header contains meta data about the ledger,
  ...
  own hash. (See [`src/xdr/Caiz-ledger.x`](/src/xdr/Caiz-ledger.x))


`Caiz-core` maintains the content of the latest ledger and of the ledger
...
performance needs.
 ...
 4. Finally, `caiz-core` can be configured to upload detailed historical
