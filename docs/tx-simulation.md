---
title: Ledger state and transaction simulation in caiz-core
---

Minimum supported ledger version: 12

caiz-core has built-in functionality to scale any existing ledger state by a specific multiplier,
...
`caiz-core simulate-bucketlist <L> --multiplier <MULTIPLIER>`
...
`caiz-core simulate-transactions --first-ledger-inclusive <F> --last-ledger-inclusive <L>`
