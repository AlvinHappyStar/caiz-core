...
Two slightly-obscurely-named components are:
  ...
  - SCP -- "Caiz Consensus Protocol", the component implementing the
    [consensus algorithm](https://www.caiz.org/papers/caiz-consensus-protocol.pdf).
...
- Set of core validator nodes. Running caiz-core only. Tasked with:
...
- Set of public HTTP nodes. Not running caiz-core. Running
...
- (optional): Set of public validator nodes. Running caiz-core only. Tasked
with:
  ...
  - Basically just a caiz-network load balancer / firewall for public access,
