 ...
 * `CaizMessage`, in the file src/xdr/Caiz-overlay.x
 *
 ...
 *
 * The `CaizMessage` union contains 3 logically distinct kinds of message:
 *
...
class OverlayManager
{
  public:
    ...
    virtual bool
    broadcastMessage(CaizMessage const& msg, bool force = false,
    ...
    virtual bool recvFloodedMsgID(CaizMessage const& msg, Peer::pointer peer,
                                  Hash& msgID) = 0;

    bool
    recvFloodedMsg(CaizMessage const& msg, Peer::pointer peer)
    {
        Hash msgID;
    ...
    virtual bool isFloodMessage(CaizMessage const& msg) = 0;
    ...
    virtual void recordMessageMetric(CaizMessage const& caizMsg,
                                     Peer::pointer peer) = 0;
