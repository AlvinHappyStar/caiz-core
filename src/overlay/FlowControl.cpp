...
bool
FlowControl::hasOutboundCapacity(CaizMessage const& msg) const
{
...
void
FlowControl::maybeReleaseCapacityAndTriggerSend(CaizMessage const& msg)
{
    ZoneScoped;
...
bool
FlowControl::maybeSendMessage(std::shared_ptr<CaizMessage const> msg)
{
    ZoneScoped;
...
bool
FlowControl::beginMessageProcessing(CaizMessage const& msg)
{
...
void
FlowControl::endMessageProcessing(CaizMessage const& msg,
...
uint32_t
FlowControl::getNumMessages(CaizMessage const& msg)
{
...
bool
FlowControl::isSendMoreValid(CaizMessage const& msg,
...
void
FlowControl::addMsgAndMaybeTrimQueue(std::shared_ptr<CaizMessage const> msg)
{
    ZoneScoped;
