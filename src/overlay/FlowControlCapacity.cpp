...
uint64_t
FlowControlMessageCapacity::getMsgResourceCount(CaizMessage const& msg) const
{
...
void
FlowControlMessageCapacity::releaseOutboundCapacity(CaizMessage const& msg)
{
    ZoneScoped;
...
uint64_t
FlowControlByteCapacity::getMsgResourceCount(CaizMessage const& msg) const
{
...
void
FlowControlByteCapacity::releaseOutboundCapacity(CaizMessage const& msg)
{
    ZoneScoped;
...
void
FlowControlCapacity::lockOutboundCapacity(CaizMessage const& msg)
{
    ZoneScoped;
...
bool
FlowControlCapacity::lockLocalCapacity(CaizMessage const& msg)
{
    ZoneScoped;
...
uint64_t
FlowControlCapacity::releaseLocalCapacity(CaizMessage const& msg)
{
    ZoneScoped;
...
bool
FlowControlCapacity::hasOutboundCapacity(CaizMessage const& msg) const
{
    ZoneScoped;
