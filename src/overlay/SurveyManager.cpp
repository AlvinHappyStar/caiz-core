...
void
SurveyManager::relayOrProcessResponse(CaizMessage const& msg,
                                      Peer::pointer peer)
{
...
void
SurveyManager::relayOrProcessRequest(CaizMessage const& msg,
                                     Peer::pointer peer)
{
...
void
SurveyManager::broadcast(CaizMessage const& msg) const
{
...
std::string
SurveyManager::getMsgSummary(CaizMessage const& msg)
{
    std::string summary;
