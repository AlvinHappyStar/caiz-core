...
class OverlayManagerImpl : public OverlayManager
{
  ...
  public:
    ...
    bool recvFloodedMsgID(CaizMessage const& msg, Peer::pointer peer,
                          Hash& msgID) override;
    ...
    bool isFloodMessage(CaizMessage const& msg) override;
    ...
    void recordMessageMetric(CaizMessage const& caizMsg,
