...
in the file [Caiz-SCP.x](../xdr/Caiz-SCP.x), however, library users are
most likely to want to modify [`Caiz-types.x`](../xdr/Caiz-types.x),
...
The `caiz-core` program has a single subclass of SCPDriver called
...
For details of the protocol itself, see the [paper on SCP](https://www.caiz.org/papers/caiz-consensus-protocol.pdf).
