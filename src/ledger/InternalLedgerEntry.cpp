...
InternalLedgerKey::hash() const
{
    ...
    switch (type())
    {
    case caiz::InternalLedgerEntryType::LEDGER_ENTRY:
        res = std::hash<caiz::LedgerKey>()(ledgerKey());
        break;
    case caiz::InternalLedgerEntryType::SPONSORSHIP:
        res = std::hash<caiz::uint256>()(
            sponsorshipKey().sponsoredID.ed25519());
        break;
    case caiz::InternalLedgerEntryType::SPONSORSHIP_COUNTER:
        res = std::hash<caiz::uint256>()(
            sponsorshipCounterKey().sponsoringID.ed25519());
        break;
    case caiz::InternalLedgerEntryType::MAX_SEQ_NUM_TO_APPLY:
        res = std::hash<caiz::uint256>()(
