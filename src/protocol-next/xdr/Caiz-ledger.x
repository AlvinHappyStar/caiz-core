...
/* CaizValue is the value used by SCP to reach consensus on a given ledger
 */
struct CaizValue
{
...
struct LedgerHeader
{
    ...
    CaizValue scpValue;   // what consensus agreed to
...
/* Ledger upgrades
note that the `upgrades` field from CaizValue is normalized such that
...
// This is in Caiz-ledger.x to due to a circular dependency 
