...
class Config : public std::enable_shared_from_this<Config>
{
  ...
  public:
    ...
    // The default way caiz-core starts is to load the state from disk and
    ...
    // captive core. This is useful for testing how caiz-core buffers ledgers
    // during captive core fast restart.
    std::chrono::seconds ARTIFICIALLY_DELAY_BUCKET_APPLICATION_FOR_TESTING;

    // A config parameter that forces caiz-core to sleep every time a task is
