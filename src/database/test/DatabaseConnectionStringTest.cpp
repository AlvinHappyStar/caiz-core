          ...
          "[db][dbconnectionstring]")
{
    ...
    {
        REQUIRE(removePasswordFromConnectionString(
                    R"(postgresql://password=abc dbname=caiz)") ==
                R"(postgresql://password=******** dbname=caiz)");
    }

    SECTION("password is removed if second")
    {
        REQUIRE(removePasswordFromConnectionString(
                    R"(postgresql://dbname=caiz password=dbname)") ==
                R"(postgresql://dbname=caiz password=********)");
    }
    ...
    SECTION("quoted password is removed")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=caiz password='quoted password')") ==
            R"(postgresql://dbname=caiz password=********)");
    }
    ...
    SECTION("parameters after password remain unchanged")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=caiz password='quoted \\ password' performance='as fast as possible')") ==
            R"(postgresql://dbname=caiz password=******** performance='as fast as possible')");
    }
    ...
    SECTION("dbname can be quored")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname='caiz with spaces' password='quoted \\ password' performance='as fast as possible')") ==
            R"(postgresql://dbname='caiz with spaces' password=******** performance='as fast as possible')");
    }
    ...
    SECTION("Bug 2234 - barewords can be any non-whitespace")
    {
        ...
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=caiz user=caiz password=thisshouldbesecret host=/var/run/postgresql/)") ==
            R"(postgresql://dbname=caiz user=caiz password=******** host=/var/run/postgresql/)");
    }
}
