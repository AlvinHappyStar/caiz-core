...
It uses the official caiz-core deb package for two reasons:
...
export TAG=${USER}/caiz-core:${STELLAR_CORE_VERSION}
make docker-build
```

## Dockerfile.testing

This is a Dockerfile for one-off builds of caiz-core during development.
...
It's intended to be run from the caiz-core source directory of a
...
```
export TAG=${USER}/caiz-core:$(git describe --always --tags --long)
