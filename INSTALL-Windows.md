...
Note that you can (and should) install the Windows version of postgres even when running caiz-core from within WSL.
...
- Open the solution `Builds\VisualStudio\caiz-core.sln`
